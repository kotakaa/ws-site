...
import { SignIn, ProductList, SignUp, Reset, ProductEdit, ProductDetail, FavoriteList, AdminSignUp, AdminTopPage, TopPage, MyPage, CostEdit} from './templates';
  ...
  return(
    <Switch>
      ...
      <Auth>
        ...
        <Route path={"/cost/edit(/:id)?"} component={CostEdit} />
